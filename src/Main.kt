...
open class Main {
  enum class Mode {
    EXTRACT_SPRITES, EXTRACT_BACKGROUNDS, DECLASH, DETECT_MAX_SIZE, SHOW_DIFFERENCE, TO_BLACK_AND_WHITE, COLOR_BACKGROUNDS
  }
  ...
  companion object {
    ...
    @JvmField
    val color = intArrayOf(0x000000, 0x00009F, 0x9F0000, 0x9F009F, 0x009F00, 0x009F9F, 0x9F9F00, 0x9F9F9F, 0x000000, 0x0000FF, 0xFF0000, 0xFF00FF, 0x00FF00, 0x00FFFF, 0xFFFF00, 0xFFFFFF)

    // options
    @JvmField
    val mode = Mode.COLOR_BACKGROUNDS
    ...
    fun main(args: Array<String>) {
      ...
      when(mode) {
        ...
        else -> Screen.process(0, -1, false)
      }
      println("Min sprite pixels is " + Sprites.minSpritePixels)
      println("Min detection area size is "
          + Sprites.maxDetectionSize + " pixels")
